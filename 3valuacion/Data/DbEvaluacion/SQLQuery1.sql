...
create proc TblEmpresas
as
select *from TblEmpresas order by TblEmpresas asc
go

exec ListarEmpresas


creat proc EncontrarRegistros
@EmpresasID int,
@puestoID  int

as 
insert into tblEmpresas values (@EmpresasID,PuestoID)
go
